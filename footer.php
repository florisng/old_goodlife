<div class="footer">
    <div class="footer_in">
        <div class="footer_right_border">
            <h3>About us</h3>
            We have built the foundation of a Professional Pharmacy Health & Beauty chain, we now want East Africans to start living the Goodlife!
            <p>
                <img src="./img/second_logo.png" class="footer_logo" alt="">
            </p>
        </div>
        <div class="footer_contact_us footer_right_border">
            <h3>Contact us</h3>
            <img src="./img/address.png" alt="" />Sylverback Mall, Kicukiro - Sonatube
            <p>
                <img src="./img/phone.png" alt="" />+250 791232266
            </p>
    ...
    <div class="small_txt">
        © 2022 Goodlife Health & Beauty - All right reserved
    </div>
</div>
